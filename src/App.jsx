...
const SFX = {
  // New "Pop": Sharp, high-pitch pop for standard completion
  success: new Audio('https://assets.mixkit.co/active_storage/sfx/2003/2003-preview.mp3'),
  
  // "Crush": Heavy cinematic impact (Kept the one you liked)
  crush: new Audio('https://assets.mixkit.co/active_storage/sfx/2570/2570-preview.mp3'),
  
  // "Fireworks": Whistling rocket + explosion for the Grand Finale
  fireworks: new Audio('https://assets.mixkit.co/active_storage/sfx/2689/2689-preview.mp3'),
};

// Preload settings
Object.values(SFX).forEach(sound => { 
    sound.volume = 0.8; // Boosted volume
    sound.preload = 'auto';
});
