      ...
      <div style={{ maxWidth: '400px', width: '100%', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        {mode === 'night' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
             {/* ... (Night Mode Header / Input - Same as before) ... */}
        ...
        {mode === 'morning' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', paddingBottom: '40px' }}>
            ...
            {/* --- MISSION TAB: ADD CONFIRM BUTTON --- */}
            ...
            {/* UPDATED CRUSHED UI WITH BUTTON */}
            ...
            {activeTab === 'ally' && viewingGoal && (
                <div style={{ animation: 'fadeIn 0.3s' }}>
                    ...
                    <div style={{ marginTop: '20px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            {/* UPDATED ALLY WINS SECTION TO SHOW NOTES */}
